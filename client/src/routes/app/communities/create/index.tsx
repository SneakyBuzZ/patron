...
function RouteComponent() {
  ...
  const [isCryptoCommunity, setIsCryptoCommunity] = useState(false);
        ...
        <div className="flex flex-col gap-6 w-2/3">
          ...
          <div className="flex flex-col gap-4 border border-neutral-800 rounded-lg p-4">
            <div className="flex items-center gap-2">
              <Settings size={18} />
              <h3 className="font-medium">Community Settings</h3>
            </div>

            <div className="flex justify-between items-center">
              <div>
                <p className="font-medium text-sm">Public Community</p>
                <p className="text-xs text-neutral-400">Anyone can join</p>
              </div>
              <Switch
                checked={isPublic}
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="font-medium text-sm">Crypto Participation</p>
                <p className="text-xs text-neutral-400">
                  Enable crypto-based participation
                </p>
              </div>
              <Switch
                checked={isCryptoCommunity}
                onCheckedChange={() => setIsCryptoCommunity(!isCryptoCommunity)}
              />
            </div>
          </div>

          <Button className="w-full md:w-fit px-8">Create Community</Button>
        </div>
